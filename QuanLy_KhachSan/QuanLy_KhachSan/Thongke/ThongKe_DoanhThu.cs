...
namespace QuanLy_KhachSan.Thongke
{
    ...
    {   public string sql_traphong = "Select * from Hoadon  where trangthai = N'Đã thanh toán'";
        ...
        {
            string chuoi = "SELECT * FROM Hoadon WHERE Ngaytraphong BETWEEN '" + date_batdau.Value + "' AND '" + date_ketthuc.Value + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //    string tenbang = " BẢNG THÔNG KÊ THU NHẬP TỪ NGÀY  " + date_batdau.Value + " ĐẾN NGÀY : " + date_ketthuc.Value;
