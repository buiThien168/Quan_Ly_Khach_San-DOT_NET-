...
namespace QuanLy_KhachSan.Thongke
{
    public partial class thongke_hoadon_kho : Form
    {
        ...
        {
            string chuoi = "SELECT * FROM NhapKho WHERE ngaynhap BETWEEN '" + date_batdau.Value + "' AND '" + date_ketthuc.Value + "'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //    string tenbang = " BẢNG THÔNG KÊ NHẬP KHO TỪ NGÀY  " + date_batdau.Value + " ĐẾN NGÀY : " + date_ketthuc.Value;
