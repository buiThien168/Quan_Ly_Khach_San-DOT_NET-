       ...
       // string id_phong_old = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
...

          {
            ...
            string sql = "Update Hoadon set Ngaytraphong='" + date_traphong.Value + "',phiphong='" + txt_phiphong.Text + "',phiphuthu='" + txt_phuthu.Text + "',thanhtien='"+txt_tongtien.Text+"',trangthai = N'Đã thanh toán' where id_hoadon = '" + txt_id_hd.Text + "'";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            //string duongdan = @"C:\Users\T\Desktop\Hotel_manager\excel\Hoadon\";
